...
class EndpointPushSubscription extends _i1.EndpointRef {
  ...
  _i2.Future<_i4.PushSubscriptionInfo> registerEndpoint({
    required String endpoint,
    String? p256dh,
    String? authSecret,
    required String deliveryMethod,
  }) =>
      caller.callServerEndpoint<_i4.PushSubscriptionInfo>(
        'pushSubscription',
        'registerEndpoint',
        {
          'endpoint': endpoint,
  ...
  ///
  /// Throws [AuthenticationException] if user is not authenticated.
  _i2.Future<List<_i4.PushSubscriptionInfo>> listSubscriptions() =>
      caller.callServerEndpoint<List<_i4.PushSubscriptionInfo>>(
        'pushSubscription',
        'listSubscriptions',
        {},
      );
  ...
  _i2.Future<_i4.PushSubscriptionInfo> updateSubscription(
    int subscriptionId, {
    bool? enabled,
  }) =>
      caller.callServerEndpoint<_i4.PushSubscriptionInfo>(
