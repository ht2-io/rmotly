...
import 'action_test_result.dart' as _i4;
import 'control.dart' as _i5;
import 'event.dart' as _i6;
import 'notification_topic.dart' as _i7;
import 'user.dart' as _i8;
import 'package:remotly_client/src/protocol/action.dart' as _i9;
import 'package:serverpod_auth_client/serverpod_auth_client.dart' as _i10;
export 'greeting.dart';
export 'action.dart';
export 'action_test_result.dart';
export 'control.dart';
export 'event.dart';
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.ActionTestResult) {
      return _i4.ActionTestResult.fromJson(data) as T;
    }
    if (t == _i5.Control) {
      return _i5.Control.fromJson(data) as T;
    }
    if (t == _i6.Event) {
    ...
    if (t == _i1.getType<_i4.ActionTestResult?>()) {
      return (data != null ? _i4.ActionTestResult.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.Control?>()) {
      return (data != null ? _i5.Control.fromJson(data) : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i4.ActionTestResult) {
      return 'ActionTestResult';
    }
    if (data is _i5.Control) {
      return 'Control';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ActionTestResult') {
      return deserialize<_i4.ActionTestResult>(data['data']);
    }
    if (dataClassName == 'Control') {
      return deserialize<_i5.Control>(data['data']);
    }
