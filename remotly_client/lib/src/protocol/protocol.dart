...
import 'package:remotly_client/src/protocol/control.dart' as _i8;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i8.Control>) {
      return (data as List).map((e) => deserialize<_i8.Control>(e)).toList()
          as T;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as T;
    }
    if (t == List<_i9.PushSubscriptionInfo>) {
      return (data as List)
          .map((e) => deserialize<_i9.PushSubscriptionInfo>(e))
          .toList() as T;
    }
